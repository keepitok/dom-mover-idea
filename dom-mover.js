...
(function () {
  ...
  // ---------------------------------------------------------------------------
  // Prompt template (intro text prepended to the exported change summary)
  // ---------------------------------------------------------------------------
  var PROMPT_TEMPLATE = [
    'These Dom Mover captures from {url} are visual directions, not a pixel-perfect specification.',
